    ...
    translation: {
      ...
      dashboard: {
        ...
        members: {
          ...
          statusInvalid: "Email non valida",
        ...
        checkins: {
          ...
          periodReport: {
            ...
            loading: "Caricamento…",
            none: "Nessun check-in riuscito in questo periodo.",
            expandHint: "Mostra tutti i check-in",
            collapseHint: "Nascondi",
            visitsInPeriod: "{{count}} check-in nel periodo",
            tableLatest: "Ultimo ingresso",
            tableEmail: "Email",
            tableName: "Nome",
            tableVisits: "Visite nel periodo",
            subheadingTimes: "Orari check-in",
            failedLoad: "Impossibile caricare il riepilogo check-in.",
            exportFilename: "check-in-per-periodo",
            exportNoData: "Carica l’elenco prima di esportare.",
          },
        },
        dialogs: {
          ...
          importDescription: "Carica un file Excel (.xlsx) con tre colonne: nome, cognome, email. Le intestazioni possono essere in italiano (es. Nome, Cognome, Nome di battesimo), inglese (First name, Name, Surname) o tedesco (Vorname, Nachname, E-Mail). I membri esistenti saranno ignorati.",
          ...
          importSkippedExisting: "Ignorate {{count}} email già presenti",
          importIgnoredTotal: "Ignorate in totale {{count}} righe",
        ...
        toasts: {
          ...
          exportPeriodCheckinsDesc: "CSV check-in per periodo: un rigo per email.",
      ...
      dashboard: {
        ...
        checkins: {
          ...
          periodReport: {
            ...
            exporting: "Exporting…",
            loading: "Loading…",
            none: "No successful check-ins in this period.",
            expandHint: "Show all check-ins",
            collapseHint: "Hide",
            visitsInPeriod: "{{count}} check-in(s) in this period",
            tableLatest: "Latest entry",
            tableEmail: "Email",
            tableName: "Name",
            tableVisits: "Visits in period",
            subheadingTimes: "Check-in times",
            failedLoad: "Could not load check-in summary.",
            exportFilename: "check-ins-by-period",
            exportNoData: "Load the list before exporting.",
          },
        },
        dialogs: {
          ...
          importDescription: "Upload an Excel file (.xlsx) with three columns: first name, last name, email. Column titles can be in English (e.g. First name, Name, Surname), Italian (Nome, Cognome, Nome di battesimo) or German (Vorname, Nachname, E-Mail). Existing members are ignored.",
          ...
          importSkippedExisting: "Skipped {{count}} emails that already exist",
          importIgnoredTotal: "Ignored {{count}} total rows",
        ...
        toasts: {
          ...
          exportPeriodCheckinsDesc: "Period check-ins exported: one row per email.",
      ...
      dashboard: {
        ...
        checkins: {
          ...
          periodReport: {
            ...
            exporting: "Export…",
            loading: "Laden…",
            none: "Keine erfolgreichen Check-ins in diesem Zeitraum.",
            expandHint: "Alle Check-ins anzeigen",
            collapseHint: "Ausblenden",
            visitsInPeriod: "{{count}} Check-in(s) im Zeitraum",
            tableLatest: "Letzter Eintritt",
            tableEmail: "E-Mail",
            tableName: "Name",
            tableVisits: "Besuche im Zeitraum",
            subheadingTimes: "Check-in-Zeiten",
            failedLoad: "Check-in-Übersicht konnte nicht geladen werden.",
            exportFilename: "check-ins-nach-zeitraum",
            exportNoData: "Bitte zuerst die Liste laden, dann exportieren.",
          },
        },
        dialogs: {
          ...
          importDescription: "Excel-Datei (.xlsx) mit drei Spalten hochladen: Vorname, Nachname, E-Mail. Spaltenüberschriften können auf Deutsch (Vorname, Nachname, E-Mail), Englisch (First name, Name, Surname) oder Italienisch (Nome, Cognome, Nome di battesimo) sein. Bestehende Mitglieder werden ignoriert.",
          ...
          importSkippedExisting: "{{count}} E-Mails übersprungen, die bereits existieren",
          importIgnoredTotal: "Insgesamt {{count}} Zeilen übersprungen",
        ...
        toasts: {
          ...
          exportPeriodCheckinsDesc: "Check-ins im Zeitraum exportiert: eine Zeile pro E-Mail.",
